        ...
        {Loading ? (
            ...
            <div>
              ...
              <div className="container tw-mb-10">
                <div
                    className="tw-bg-gradient-to-r tw-from-[#ffffff66] tw-to-[#ffffff0d] tw-py-[80px] tw-px-[100px] tw-rounded-[16px] tw-flex tw-justify-between">
              ...
              <div>
                ...
                <div className="container tw-mb-10 tw-flex">
                  <div className="tw-w-[60%] tw-flex tw-items-center tw-justify-center">
                    <div
                        className="tw-px-[40px] tw-py-[60px] tw-bg-gradient-to-r tw-from-[#ffffff66] tw-to-[#ffffff0d] tw-rounded-tl-[16px] tw-rounded-bl-[16px]">
              ...
              <div className="container tw-mb-10">
                <div
                    className=" tw-bg-[#272621] tw-rounded-[16px] tw-w-full tw-p-[40px] 3xl:tw-p-[80px] tw-flex tw-h-[450px]">
